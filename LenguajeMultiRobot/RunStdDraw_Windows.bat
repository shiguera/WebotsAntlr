...
REM InterpreteStdDraw - Ejecuta código RoboLang con gráficos y sonido
...
echo.
echo ╔═══════════════════════════════════════════════╗
echo ║ 🎨 InterpreteStdDraw - Archivo: %PARAM_JAVA%  ║
echo ╚═══════════════════════════════════════════════╝
echo.
...
echo ⚙️  Ejecutando StdDraw + StdAudio...
java -cp "%CP%" ^
     interpretes.InterpreteStdDraw "%PARAM_JAVA%"

echo.
echo ╔═══════════════════════════════════════════════╗
echo ║ 🎉 Simulación StdDraw finalizada              ║
echo ║ 💡 Ventana queda abierta - cierra manualmente ║
echo ╚═══════════════════════════════════════════════╝
echo.
