...
public class RobotParser extends Parser {
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RobotListener ) ((RobotListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RobotListener ) ((RobotListener)listener).exitProg(this);
		}
	}
	...
	public static class GiraContext extends StatementContext {
		public TerminalNode VALUE() { return getToken(RobotParser.VALUE, 0); }
		public GiraContext(StatementContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RobotListener ) ((RobotListener)listener).enterGira(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RobotListener ) ((RobotListener)listener).exitGira(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class AvanzaContext extends StatementContext {
		public List<TerminalNode> VALUE() { return getTokens(RobotParser.VALUE); }
		public TerminalNode VALUE(int i) {
			return getToken(RobotParser.VALUE, i);
		}
		public AvanzaContext(StatementContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RobotListener ) ((RobotListener)listener).enterAvanza(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RobotListener ) ((RobotListener)listener).exitAvanza(this);
		}
	}
